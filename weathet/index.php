...
<head>
    ...
    <title>A Dashboard Weather | Weathet</title>
</head>
<body>
    ...
    <div class="container">
        <div class="section">
            <div class="box">
                <form action="index.php" method="post" onchange="document.getElementById('form').action = this.value;">
            ...
            <?php require_once 'show_widget_index.php';?>
        </div>
    </div>
